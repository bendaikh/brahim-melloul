<div class="section-list" style="padding: 20px 0;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        ...
        <button class="btn btn-primary" onclick="app.loadModule('categories', 'Catégories')" style="display: flex; align-items: center; gap: 8px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead>
                <tr style="border-bottom: 2px solid #e0e0e0; background: #f5f5f5;">
                    ...
                    <th style="text-align: left; padding: 12px; font-weight: 600; color: #333;">Catégorie Parente</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #e0e0e0;">
                    ...
                    <td style="padding: 12px; color: #666;">{{ $category->parent->name ?? '-' }}</td>
                    ...
                    <td style="padding: 12px; text-align: right;">
                        <a href="{{ route('admin.parametres.categories.edit', $category) }}" style="display: inline-block; padding: 6px 12px; background: #e3f2fd; color: #1976d2; border-radius: 4px; text-decoration: none; font-size: 12px; margin-right: 4px;">
                            <i class="fas fa-edit"></i> Modifier
                        </a>
                        <form action="{{ route('admin.parametres.categories.destroy', $category) }}" method="POST" style="display: inline-block; margin: 0;" onsubmit="return confirm('Êtes-vous sûr ?');">
                            @csrf
                            @method('DELETE')
    ...
    <div style="text-align: center; padding: 40px; color: #999;">
        ...
        <button class="btn btn-primary" onclick="app.loadModule('categories', 'Catégories')" style="margin-top: 16px;">
