...
<div class="max-w-4xl">
    ...
    <div class="bg-dark-800 rounded-2xl border border-white/10 p-6">
        <div class="flex items-center space-x-3 mb-6">
            ...
            <div>
                <h2 class="text-lg font-semibold">Créer un article</h2>
                    ...
                    <div>
                        ...
                        <select name="car_logo_id" id="car_logo_id"
                            ...
                            @foreach($carLogos as $carLogo)
                                <option value="{{ $carLogo->id }}" {{ old('car_logo_id') == $carLogo->id ? 'selected' : '' }}>
                                    {{ $carLogo->name }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="classment" id="classment" value="{{ old('classment') }}"
                            class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/40 focus:border-brand-500 focus:outline-none transition"
                    ...
                    <div>
                        ...
                        <input type="text" name="diametre" id="diametre" value="{{ old('diametre') }}"
                            class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/40 focus:border-brand-500 focus:outline-none transition"
                ...
                <div>
                    ...
                    <input type="text" name="reference_equivalent" id="reference_equivalent" value="{{ old('reference_equivalent') }}"
                        class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/40 focus:border-brand-500 focus:outline-none transition"
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" name="prix_brut" id="prix_brut" value="{{ old('prix_brut', 0) }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" name="remise" id="remise" value="{{ old('remise', 0) }}"
                                class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/40 focus:border-brand-500 focus:outline-none transition pr-16"
                                placeholder="0.00" oninput="calculateNetPrice()">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" name="prix_net" id="prix_net" value="{{ old('prix_net', 0) }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" name="prix_achat" id="prix_achat" value="{{ old('prix_achat', 0) }}"
                                class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/40 focus:border-brand-500 focus:outline-none transition pr-16"
                                placeholder="0.00">
                            <span class="absolute right-4 top-1/2 -translate-y-1/2 text-white/40">MAD</span>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" name="representant_prix" id="representant_prix" value="{{ old('representant_prix', 0) }}"
                                class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/40 focus:border-brand-500 focus:outline-none transition pr-16"
                                placeholder="0.00">
                            <span class="absolute right-4 top-1/2 -translate-y-1/2 text-white/40">MAD</span>
                        </div>
